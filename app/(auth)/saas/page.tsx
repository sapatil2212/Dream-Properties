              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    <option value={(UserRole as any).ADMIN}>Admin</option>
                    <option value={(UserRole as any).TELECALLER}>Telecaller</option>
                    <option value={(UserRole as any).SALES_EXECUTIVE}>Sales Executive</option>
                  </select>
