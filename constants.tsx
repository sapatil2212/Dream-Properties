...
import { LayoutDashboard, Building2, Users, PieChart, BadgePercent, PhoneCall, CalendarCheck, Settings, CreditCard, LifeBuoy, Megaphone, Inbox, Heart, Home, FileText } from 'lucide-react';
...
export const NAV_ITEMS = {
  [UserRole.SUPER_ADMIN]: [
    ...
    { label: 'Channel Partners', icon: <Users size={20} />, href: '/dashboard/channel-partners' },
  ...
  [UserRole.CHANNEL_PARTNER]: [
    { label: 'Overview', icon: <LayoutDashboard size={20} />, href: '/dashboard' },
    { label: 'Marketplace', icon: <Building2 size={20} />, href: '/dashboard/properties' },
    { label: 'Post Property', icon: <Building2 size={20} />, href: '/dashboard/post-property' },
    { label: 'My Leads', icon: <Users size={20} />, href: '/dashboard/leads' },
    { label: 'Commissions', icon: <BadgePercent size={20} />, href: '/dashboard/commissions' },
    { label: 'Payouts', icon: <CreditCard size={20} />, href: '/dashboard/payouts' },
    { label: 'Agreement', icon: <FileText size={20} />, href: '/dashboard/partner-agreement' },
    { label: 'Settings', icon: <Settings size={20} />, href: '/dashboard/settings' },
  ],
  [UserRole.BUILDER]: [
  ...
  [UserRole.USER]: [
    ...
    { label: 'Back to Home', icon: <Home size={20} />, href: '/' },
  ],
  [UserRole.BUYER]: [
    { label: 'Interested', icon: <Heart size={20} />, href: '/dashboard/profile/favorites' },
    { label: 'Account Settings', icon: <Settings size={20} />, href: '/dashboard/profile/settings' },
