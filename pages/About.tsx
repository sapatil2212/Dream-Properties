...
import { Building2, Users, Award, Globe, Heart, ShieldCheck, TrendingUp, CheckCircle2 } from 'lucide-react';
...
export const AboutPage: React.FC = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white">
      {/* Redesigned Hero Section - Solid Background, Centered Content */}
      ...
      {/* Vision Statement Section - Enhanced Line Spacing & Background Map */}
